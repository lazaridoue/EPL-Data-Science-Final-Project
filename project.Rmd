...
<p> Here we calculate the general probability of a team going to score and we compare this to the opposite team. We used this method based on a project made by Gupta Apaar. We can now formulate the lambda parameter as follows: (Apaar, 2019)</p>
